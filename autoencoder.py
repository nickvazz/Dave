    ...
    for L1, L2, L3, L4 in layer_trials:
        ...
        with tf.Graph().as_default():
            with tf.variable_scope("autoencoder_model"):
                ...
                if not os.path.exists("layer_tensors/" + filename):
                    os.makedirs("layer_tensors/" + filename)
                ...
                np.savetxt('layer_tensors/' + filename + '/' + 'L1W.txt', L1W, delimiter='', fmt='%10.5f')
                np.savetxt('layer_tensors/' + filename + '/' + 'L2W.txt', L2W, delimiter='', fmt='%10.5f')
                np.savetxt('layer_tensors/' + filename + '/' + 'L3W.txt', L3W, delimiter='', fmt='%10.5f')
                np.savetxt('layer_tensors/' + filename + '/' + 'L4W.txt', L4W, delimiter='', fmt='%10.5f')

                np.savetxt('layer_tensors/' + filename + '/' + 'L1b.txt', L1b, delimiter='', fmt='%10.5f')
                np.savetxt('layer_tensors/' + filename + '/' + 'L2b.txt', L2b, delimiter='', fmt='%10.5f')
                np.savetxt('layer_tensors/' + filename + '/' + 'L3b.txt', L3b, delimiter='', fmt='%10.5f')
                np.savetxt('layer_tensors/' + filename + '/' + 'L4b.txt', L4b, delimiter='', fmt='%10.5f')
                ...
                def save_data():
                    ...
                    np.savetxt('reduced_data/' + filename + '/AfterL1_' + filename + '.txt', final_l1, delimiter=' ')
                    np.savetxt('reduced_data/' + filename + '/AfterL2_' + filename + '.txt', final_l2, delimiter=' ')
